...
class ReferralModel(Base):
    ...
    referred_by_specialty = Column(String, nullable=True)
    speciality = Column(String)
    target_doctor = Column(String, nullable=True)
    date = Column(String)
    reason = Column(String)
    clinical_notes = Column(String, nullable=True)
    referred_from_notes = Column(String, nullable=True)
    ...
    doctor_b_notes = Column(String, nullable=True)
    doctor_b_treatment_plan = Column(JSON, nullable=True)
    completed_at = Column(String, nullable=True)
    billing_request_id = Column(Integer, nullable=True)
