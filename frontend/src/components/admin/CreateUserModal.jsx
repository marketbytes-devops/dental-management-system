        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-5 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
            <button 
              type="button"
              onClick={onClose}
              className="px-4.5 py-2 text-xs font-bold text-gray-600 bg-white border border-gray-250 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer outline-none"
            >
              Cancel
            </button>
            <button 
