...
export default function LabDashboard() {
  ...
  // Case Priority Breakdown (mock data)
  const casePriority = [
    { priority: "Urgent", count: 12, color: "bg-danger" },
    { priority: "High", count: 25, color: "bg-warning" },
    { priority: "Medium", count: 45, color: "bg-primary" },
    { priority: "Low", count: 60, color: "bg-gray-400" }
  ];
