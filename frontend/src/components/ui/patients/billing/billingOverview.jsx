  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden">
        ...
        <p className={`text-xs mt-1.5 font-medium ${outstanding > 0 ? "text-danger" : "text-gray-500"}`}>
          {outstanding > 0 ? "⚠️ Requires immediate payment" : "No pending due"}
        </p>
      </div>
    </div>
  );
